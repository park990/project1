//StudentFrame 수정본 이에요 최최종이에요 (아마도)
/*
...
public class StudentFrame extends JFrame {
    ...
    MemberVO vo;
    public StudentFrame(MemberVO vo) throws IOException {
        this.vo = vo;
...
//        // 로그인 -> member_t에서 stdno 가져와야됨 (생성자 파라메터로 넘겨주기?)
        ...
        this.setBounds(300, 100, 900, 800);
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (col == 5) { // 버튼 열
                    ...
                    if ("시험 응시".equals(cellValue)) {
                        ...
                        new Dialog(vo, StudentFrame.this);
...
//    }//Main함수 끝
    ...
    private void set_card() throws IOException {
        ...
        stdvo = ss.selectOne("std.get_no", vo.getStdno());
        if (stdvo != null) {
//            System.out.printf("%s, %s, %s, %s, 사진 : %s\n", stdvo.getStd_name(), stdvo.getStd_email(), stdvo.getStd_phone(), stdvo.getStd_address(), stdvo.getStd_image());
            ...
            jLabel_birth.setText(vo.getMem_birth());
...
//            System.out.println(shortPath);
    ...
    //학생 카드 수정 메소드 ===============================================================================
    //시험 응시 후 화면 초기화 메소드 ======================================================================
    private void update_table() throws IOException {
    ...
    private void search() throws IOException {
        ...
        list = ss.selectList("std.get_total", vo.getStdno());
...
//                System.out.println(vo.getAd_sdate());
            ...
            System.out.println("강의실 list = null");
...
//                System.out.printf("임시 출력: %s, %s, %s, %s, %s\n", vo2.getAd_name(), vo2.getLec_name(), vo2.getLec_sdate(), vo2.getLec_edate(), vo2.getLec_info());
    ...
    public void search2() throws IOException {
        ...
        test_list = ss.selectList("std.get_test", vo.getStdno());
        ...
        if (test_list != null && test_list.size() > 0) { //DB로부터 받은 data가 있을 때만 수행
            ...
            int i = 0;
            for (testDTO vo2 : test_list) {
                data[i][0] = vo2.getLec_no();// 강의 코드
                data[i][1] = vo2.getLec_name(); //강의명 출력
                data[i][2] = vo2.getAd_name(); //강사명 들어가야됨
                data[i][3] = vo2.getTest_name(); // 시험이름 들어가야됨

                //================응시 여부==================
                //test_idx를 넘겨줘야됨. -> test_idx에 해당되는 stdno들을 뽑아내서 스트링 배열에 저장함.
                List<stdVO> auth_list = ss.selectList("std.get_test_auth", vo2.getTest_idx());
                ...
                if (auth_list != null && !auth_list.isEmpty()) {
                    ...
                    for (stdVO avo : auth_list) {
                        if (avo.getStdno().equalsIgnoreCase(vo.getStdno())) {
                            //두 개의 학번이 같으면? -> 응시 완료
            ...
            System.out.println("시험 없음 // test_list is null");
        }
