...
CREATE TABLE `test_t` (
  `test_idx` bigint NOT NULL AUTO_INCREMENT,
  `lec_no` varchar(12) NOT NULL,
  `test_name` varchar(12) NOT NULL,
  `test_ques_num` bigint NOT NULL,
...
INSERT INTO `test_t` VALUES (9,'18','중간고사',13),(10,'18','테스트 문제',3),(13,'19','중간 고사',5);
